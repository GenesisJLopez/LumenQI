                ...
                {editingConversationId !== conversation.id && (
                  <div className="flex items-center space-x-1">
                    <Button
                      ...
                      className="opacity-80 group-hover:opacity-100 hover:opacity-100 transition-all duration-200 p-1 h-7 w-7 text-blue-500 hover:text-blue-700 hover:bg-blue-100 dark:hover:bg-blue-800/30 flex-shrink-0 rounded-md z-10"
                    ...
                    <Button
                      ...
                      className="opacity-80 group-hover:opacity-100 hover:opacity-100 transition-all duration-200 p-1 h-7 w-7 text-red-500 hover:text-red-700 hover:bg-red-100 dark:hover:bg-red-800/30 flex-shrink-0 rounded-md z-10"
